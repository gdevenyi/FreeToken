...
def test_mapped_developer_messages_are_merged_into_one_leading_system_message():
    """Mapping developer -> system can add a second or non-first system message; a template
    that rejects a non-first system message must still get exactly one, first."""
    from freetoken.tokenizer.tokenize import _map_developer_role
